...
public class HomeEthyleneLive extends Fragment {
    ...
    private final String  node = "Ethylene";
                        ...
                        if (activity != null) {
                            activity.runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    change = change + 1;
                                    u1 +=1;
                                    LineDataSet set1 = new LineDataSet(yvalues, "Co2ppm");
                                    ...
                                    mchart.setData(data);
                                    min_temp.setText("MIN : "+ min1   + " ppm");
                                    avg_temp.setText("AVG : "+ avg   + " ppm");
                                    max_temp.setText("MAX : "+ max1   + " ppm");

                                    speedView.speedTo(compare*1000);

                                    if (speedView.getSpeed()>50 || speedView.getSpeed() < 100){
                                        speedView.getSections().clear();
