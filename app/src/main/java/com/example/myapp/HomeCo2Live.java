...
public class HomeCo2Live extends Fragment {
    ...
    private final String  node = "co2ppm";
                        ...
                        if (activity != null) {
                            activity.runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    if (speedView.getSpeed()>1500 || speedView.getSpeed() < 2200){
                                        speedView.getSections().clear();
